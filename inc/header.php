	...
	<body>
		...
		<svg xmlns="http://www.w3.org/2000/svg" class="svg-defs" title="header svgs">
			...
			<symbol id="home" viewbox="0 0 24 24">
				<path fill="#ECEFF1" d="M23.84,11.615l-4.203-4.204V1.636c0-0.301-0.245-0.545-0.546-0.545h-3.272c-0.301,0-0.546,0.245-0.546,0.545
			...
			<symbol id="menu" viewbox="0 0 24 19.635">
				<path fill="#ECEFF1" d="M21.818,7.637H2.182C0.977,7.637,0,8.612,0,9.818C0,11.022,0.977,12,2.182,12h19.637
