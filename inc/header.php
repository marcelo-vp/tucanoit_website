...
<html lang="pt">
	...
	<body>
		...
		<svg xmlns="http://www.w3.org/2000/svg" class="svg-defs" title="header svgs">
			<symbol id="at-sign-teal" viewbox="0 0 24 23.99">
				<path fill="#00695c" d="M22.461,17.891c-0.518,0.703-1.132,1.372-1.828,1.99c-0.695,0.617-1.475,1.162-2.317,1.62
			...
			<symbol id="pencil-teal" viewbox="0 0 24 24">
				<path fill="#00695c" d="M0,4.363c0,1.205,0.488,2.296,1.278,3.086l14.727,14.727L24,24l-1.823-7.994L7.449,1.277
			...
			<symbol id="phone-teal" viewbox="0 0 24 24">
				<path fill="#00695c" d="M23.999,19.082h-0.008c0-0.451-0.183-0.859-0.479-1.156c-0.087-0.088-0.185-0.16-0.289-0.227l-4.619-3.592
			...
			<symbol id="close" viewbox="0 0 24 24">
				<path fill="#00695c" d="M12.943,12L23.805,1.138C23.926,1.018,24,0.851,24,0.667C24,0.299,23.702,0,23.333,0
